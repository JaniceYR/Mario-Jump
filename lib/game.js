...
class Game {
  constructor(ctx) {
    this.ctx = ctx;
    // this.font = new FontFace('press-start-2p', "url('./asset/fonts/PressStart2P-Regular.ttf')");
  ...
  addScore() {
    ...
    // // this.font.load().then(() => {
    // this.ctx.fillText("MARIO", 10, 15);
    // this.ctx.fillText(`${Math.floor(this.score)}`, 20, 25);
    // });
